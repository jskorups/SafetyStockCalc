    ...
    public partial class SSC : Form
    {
        ...
        private void loadDataBtn_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ee)
            {
                ...
                MessageBox.Show("Coś poszło nie tak" + System.Environment.NewLine + ee.Message);
            }
        ...
        private void editProjektBtn_Click(object sender, EventArgs e)
        {
            using (var newdiv = new EditProject())
                newdiv.ShowDialog();
        ...
        private void editSapBtn_Click(object sender, EventArgs e)
        {
            using (var newdiv = new EditSAP())
                newdiv.ShowDialog();
        ...
        private void SaveValidation(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(combMod.Text) || string.IsNullOrEmpty(combSap.Text) || string.IsNullOrEmpty(combProj.Text)
                || string.IsNullOrEmpty(combMod.Text) || string.IsNullOrEmpty(week1Txt.Text) || string.IsNullOrEmpty(week2Txt.Text)
                || string.IsNullOrEmpty(week3Txt.Text) || string.IsNullOrEmpty(week4Txt.Text) || string.IsNullOrEmpty(week5Txt.Text)
                || string.IsNullOrEmpty(itemPricetxt.Text) || string.IsNullOrEmpty(cycleTimeTxt.Text))
            {
